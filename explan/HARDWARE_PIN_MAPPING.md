...
| **모터 드라이버 (L298N)** | GPIO 23, 24 | PIN 16, 18 | IN1, IN2 (우측 모터 방향 제어) | ✅ 연결됨 |
| | GPIO 27, 22 | PIN 13, 15 | IN3, IN4 (좌측 모터 방향 제어) | ✅ 연결됨 |
...
> **참고:** L298N의 ENA/ENB는 점퍼로 5V에 항상 연결되어 있으므로 소프트웨어에서 제어하지 않습니다.
